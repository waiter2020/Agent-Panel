...
/// <reference types="D:/Project/Agent Panel/frontend/node_modules/@ant-design/pro-components" />
...
import {
  ProLayout,
} from "D:/Project/Agent Panel/frontend/node_modules/@ant-design/pro-components";
import './Layout.css';
...
const { formatMessage } = useIntl();
  ...
  return (
    <ProLayout
      route={route}
      location={location}
      title={userConfig.title || 'agent-panel-frontend'}
      navTheme="dark"
      siderWidth={256}
      onMenuHeaderClick={(e) => {
        e.stopPropagation();
